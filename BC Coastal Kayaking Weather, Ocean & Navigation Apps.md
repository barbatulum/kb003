...
- 官方預報與警報 (海象預警/ 強風警報 / 氣象浮標), 用來確認風險底線
- Marine Forecasts and Warnings for Canada 是加拿大氣象局針對本地氣象提出預報/警報, 獨木舟出航必聽. 
- VHF weather channel 在 BC 沿海會循環播放 Marine Forecasts and Warnings for Canada, 主要用 WX1-WX4( 162 MHz, 可用 scan 尋找頻道), 在 inlet, fjord 或地形遮蔽時會收不到
	- Strait of Georgia / Vancouver / Victoria: WX1 / WX2
	- West Coast (Tofino / Ucluelet): WX3 / WX4
	- Central Coast (Broughton Archipelago): WX3 / WX4
	- BC 北部沿海主要靠 offshore transmitter

**[PredictWind](https://apps.apple.com/us/app/predictwind-marine-forecasts/id477048487)** ([web](https://www.predictwind.com/))  
基於 ECMWF / GFS 下採樣的高解析度模型 (PWE / PWG)

- 一公里精度
- 多日趨勢 / 天氣窗口 / 湧浪預測 (from wave model, e.g. WW3)
- 支援離線預報資料 (GRIB)

**[Windy](https://apps.apple.com/us/app/windy-com/id1161387262)** ([web](https://www.windy.com/))  
多模型 (ECMWF / GFS / ICON) 視覺化, 用來理解風場 、地形影響、航線上的變化, 看模型分歧, 是”模型計算結果”不是觀測

**[Windfinder Pro](https://apps.apple.com/us/app/windfinder-pro-wind-weather/id336901296)**

- ECMWF (Superforecast) + 針對點的詳細資訊
- 單點時間曲線 (何時變強 / gust)
- 適合啟航, 登陸和導航點的天候判斷

**[FishWeather](https://apps.apple.com/us/app/fishweather-marine-forecasts/id555644333)**

- 整合氣象浮標, 燈塔和私人站觀測的短期預測, 用來確認”現在”天氣海況.
- 即時風況 (風速,陣風和風勢趨勢)
- 加拿大只有在溫哥華,維多利亞範圍才實用, 其他地區氣象站和氣象浮標數量太少.

**[MyRadar](https://apps.apple.com/us/app/myradar-accurate-weather-radar/id322439990)**

- 即時降雨 / 雷達（風暴 / 雨帶)
- 用於觀察降雨分布、鋒面移動與對流發展（短時間天氣變化）
- 可判斷降雨是否即將影響航程與能見度
- 沒有可靠的風場、海況或潮流資訊，對預測幫助有限
