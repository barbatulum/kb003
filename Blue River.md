...
- 綠色是 **delta 主 channel**, 水道 **最寬**, 水流 **微弱但連續**, 很少 dead end, 比較深
- 黃色是從 Beaver marsh side channel 之後要轉向的路
![[Pasted image 20260316094732.png]]
	
### 北到南順流(North Thompson River) 
- 起點
	- 從北方 15 公里的 **Highway 5 跨河大橋**（接近 Lempriere 區域）下船
	- Albreda bridge launch 下船
- 終點
	- 划到 River Safari
	- 划到 River Safari, 左轉進 Mud Creek(River)
	- 划到 Blue River 右轉回鎮上
- 
